...
#' rows matching the maximum value), or \code{"all"} (for min, median, and
#' max); alternatively, a numeric vector can be specified with the desired
#' quantiles, for instance \code{c(0, .25, .5, .75, 1)}.
#' @author Ananda Mahto
