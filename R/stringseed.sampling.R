...
#'
#'The \code{\link{stringseed.sampling}} function is designed as a batch sampling function that allows the user to specify any alphanumeric input as the seed \emph{per sample in the batch}.
#'
