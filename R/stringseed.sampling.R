...
#' @param write.output Logical. Should the output be written to a file?
#' Defaults to \code{FALSE}. If \code{TRUE}, a csv file is written with the
#' sample "metadata", and a plain text file is written with the details of the
#' resulting sample. The names of the files written are \code{"Sample frame
#' generated on {date the script was run} .csv"} and \code{"Samples generated
#' on {date the script was run} .txt"} and will be found in your current
#' working directory.
...
#' are: \itemize{ \item \code{input}: The "metadata" to remind you of your
#' input parameters.  \item \code{samples}: The samples resulting from the
#' specified input parameters. In the case of batch sampling being used,
#' \code{samples} will be a named list. } Use
#' \code{print.default(your-object-here)} to view the underlying list.
#' @author Ananda Mahto
