...
#'instance \code{xtabs} and \code{table}, will create an array of tables as the
#'output when more than two variables are being tabulated. \itemize{ \item If
#'\code{as.multitable} is \code{TRUE}, the function will return a list of
#'\code{data.frame}s. \item If \code{as.multitable} is \code{FALSE}, the
#'function will convert the object to an \code{ftable} object before performing
#'the transformation. }
