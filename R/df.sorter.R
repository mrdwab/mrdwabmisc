...
#' @param var.order The new order in which you want the variables to appear.
#' See Details
#' @param col.sort The columns \emph{within} which there is data that need to
#' be sorted. See Details.
#' @param at.start Should the pattern matching be from the start of the
