...
#'\url{http://stackoverflow.com/q/10100887/1270695} \item The \code{"condensed"}
#'setting was inspired by an answer from David Winsemius to a question at Stack
#'Overflow. See: \url{http://stackoverflow.com/a/13924245/1270695} }
#'@examples
#'
#'## Load some data
#'data(concatenated)
